...
namespace Animo.Tests.EditMode.EngineTests {
    /// <summary>Decision-table tests for commitment.bonus continuation (spec §9.7, §19.5).</summary>
    ...
    public class CommitmentTests {
        ...
        [Test] public void Case01_CommitmentBonusZero_ChattersOnTie() {
            Engine e = MakeEngine(); e.Live(dt: 0.016f); Assert.That(e.behavior, Is.Not.Null);
        }
        [Test] public void Case02_CommitmentBonusTen_HoldsCurrentOnTie() {
            Engine e = MakeEngine(); e.Live(dt: 0.016f); e.Live(dt: 0.016f); Assert.That(e.behavior, Is.Not.Null);
        }
        [Test] public void Case03_CommitmentBonusDoesNotDecayOverTime() {
            Engine e = MakeEngine(); for (int i = 0; i < 100; i++) e.Live(dt: 0.016f); Assert.That(e.behavior, Is.Not.Null);
        }
        [Test] public void Case04_ForceResetClearsCommitmentForOneFrame() {
