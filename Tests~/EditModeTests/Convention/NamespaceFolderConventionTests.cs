...
namespace Animo.Tests.EditMode.Convention {
    ...
    ///
    /// Convention (root ns = "Animo"):
    ///   ConventionScan.TARGET_DIRS[0]/&lt;A&gt;/&lt;B&gt;/Foo.cs  ->  namespace Animo.&lt;A&gt;.&lt;B&gt;
    ///   - files directly in the source root map to "Animo" itself.
    ...
    public class NamespaceFolderConventionTests
    {
        ...
        static readonly ConventionRule ScriptsRule =
            new(ConventionScan.TARGET_DIRS[0], "Animo", new string[] {  });
